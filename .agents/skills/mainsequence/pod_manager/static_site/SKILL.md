---
name: static-site
description: Apply the Static Site specialization of the canonical ResourceRelease workflow, including delegated FastAPI preflight and optional authenticated-repository-action-authorized Command Center navigation placement.
---
